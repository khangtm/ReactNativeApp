...
import icBack from './../../media/icon/back_white.png';
...
export default class Authentication extends Component {
  ...
  render() {
    const {
            headerRow, iconStyle, titleStyle,
    ...
    const mainJSX = isSignIn ? <SignIn goBackToMain={this.goToMain.bind(this)} /> : <SignUp gotoSignIn={this.gotoSignIn.bind(this)} />;
    return (
